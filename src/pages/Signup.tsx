...
import { Mail, Lock, ArrowRight, User, Phone, ArrowLeft } from "lucide-react";
...
const Signup = () => {
  ...
  const handleSendOtp = async () => {
    ...
    setLoading(true);
    try {
      const result = await sendPhoneOtp(formattedPhone, "recaptcha-container-signup");
              ...
              <motion.div key="email" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <Button type="submit" variant="hero" size="xl" className="w-full" disabled={loading}>
                    {loading ? <><img src="/assets/RideSync.gif" className="h-5 w-auto object-contain mr-2" alt="Loading" />Creating account...</> : <>Create Account <ArrowRight className="h-4 w-4" /></>}
                  </Button>
                </form>
                ...
                <Button variant="outline" className="rounded-xl h-11 w-full" onClick={handleGoogleSignup}>
                ...
                {!otpSent ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <Button variant="hero" size="xl" className="w-full" onClick={handleVerifyOtp} disabled={loading}>
                      {loading ? <><img src="/assets/RideSync.gif" className="h-5 w-auto object-contain mr-2" alt="Loading" />Verifying...</> : <>Verify & Sign Up <ArrowRight className="h-4 w-4" /></>}
                    </Button>
